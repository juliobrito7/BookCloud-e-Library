...
const LoginPage = () => {
    ...
    return <div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
            <motion.div className='sm:mx-auto sm:w-full sm:max-w-md' initial={{ opacity: 0, y: -20}} animate={{ opacity: 1, y: 0}} transition={{ duration: 0.8 }}>
                <h2 className='mt-6 text-center text-3x1 font-extrabold text-emerald-400'>Inicia Sesión En Tu Cuenta</h2>
            </motion.div>
            ...
            <motion.div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md' initial={{ opacity: 0, y: 20}} animate={{ opacity: 1, y: 0}} transition={{ duration: 0.8, delay: 0.2}}>
                <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                    ...
                    <p className='mt-8 text-center text-sm text-gray-400'>
                        ...
                        Crea tu cuenta ahora <ArrowRight className='inline h-4 w-4' />
                        </Link>
                    </p>
                </div>
            </motion.div>
